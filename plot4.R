...
attach(mtcars)
par(mfrow=c(2,2))
plot(posix, acpwr, type="l", ylab="Global Active Power")
...
legend("topright", c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), bty = "n", lty=c(1,1,1), lwd=c(1,1,1), col=c("black","red","blue"), pch=0.1, cex=0.6)
